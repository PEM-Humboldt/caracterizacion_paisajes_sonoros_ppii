...
El script [audio_metadata_utilities.R](preprocessing/audio_metadata_utilities.R) contiene las funciones
necesarias y [read_audio_metadata.R](preprocessing/read_audio_metadata.R) presenta el paso a paso para
