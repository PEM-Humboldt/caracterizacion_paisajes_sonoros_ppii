...
#path_audio = '/Users/jsulloa/Downloads/tmp/'
path_flist_sel = '../../../audio_metadata/audio_metadata_lluvias.csv'
...
for sensor_name in sensor_list:
    ...
    for idx_row, row in flist_sel.iterrows():
        print(idx_row+1, '/', flist_sel.index[-1], ':', row.fname_audio)
        ...
        add_info = row[['fname_audio', 'sensor_name', 'date']]
