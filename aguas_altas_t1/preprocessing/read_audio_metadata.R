...
# set variables
path_files = '/Volumes/PAPAYA/ANH/'  # Folder location of acoustic dataset
fpath_save = '../../audio_metadata/audio_metadata.csv' # Filename of csv that will store the metadata
# ---------------
...
table(df$length)
#df = df[-which(df$length<59 | df$length>61),]
