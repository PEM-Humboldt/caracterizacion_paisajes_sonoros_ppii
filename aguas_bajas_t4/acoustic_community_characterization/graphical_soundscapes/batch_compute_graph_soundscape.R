...
## SET VARIABLES
path_audio_dataset = '/Volumes/Humboldt/'  # location of audio dataset
path_save_gs = './dataframes/'  # location to save the dataframe
path_metadata = '../../audio_metadata/audio_metadata_aguas_bajas_t4_subsample.csv'  # location to metadata information
path_save_fig = './figures/'  # location to save the figure
path_rain_data = '../../detection/rain_predictions_multi.csv'
