...
num_rec_perday = 48
num_days = 20
flist_full = pd.read_csv('../audio_metadata/audio_metadata_aguas_bajas_t3.csv')
...
rm_sites = {'SMU06597', 'SMU05597', 'G079', 'G6585', 'G092', 'G6594', 'G6598'}  
...
#%% save
flist_subsample.to_csv('../audio_metadata/audio_metadata_aguas_bajas_t3_subsample.csv', index=False)